...
public class EquipTriggerRoundStartRecoverAffix extends BaseEquipAffix {

    public EquipTriggerRoundStartRecoverAffix(int affixId, String affixName, String description, Rarity rarity,
