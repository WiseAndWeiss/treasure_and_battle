...
import com.example.treasure_and_battle.model.item.ConsumableItem.BuffEntry;
import com.example.treasure_and_battle.model.item.ConsumableItem.DebuffEntry;
import com.example.treasure_and_battle.model.item.ConsumableItem.Effect;
import com.example.treasure_and_battle.model.item.ConsumableItem.Target;
...
public class ConsumableExecutorTest {
    ...
    public void testNullPlayer() {
        assertFalse(ConsumableExecutor.execute(null, null, createHealItem(), context));
    }

    @Test
    public void testNullItem() {
        assertFalse(ConsumableExecutor.execute(player, null, null, context));
    }
    ...
    public void testNullEffects() {
        ...
        assertFalse(ConsumableExecutor.execute(player, null, item, context));
    }
    ...
    public void testEmptyEffects() {
        ...
        assertTrue(ConsumableExecutor.execute(player, null, item, context));
    }
    ...
    public void testHealHP_WithShieldDuration() {
        ...
        assertTrue(ConsumableExecutor.execute(player, new BattleContext(player, new ArrayList<>(), false), item, context));
    }
    ...
    public void testDamageSingleEnemy() {
        ...
        ConsumableItem item = new ConsumableItem("bomb", "炸弹",
                Rarity.COMMON, 10, 10, true, true, Arrays.asList(e), "");
        assertTrue(ConsumableExecutor.execute(player, ctx, item, context));
